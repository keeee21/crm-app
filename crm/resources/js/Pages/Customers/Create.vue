                            ...
                            <form @submit.prevent="storeCustomer">
                                <div class="container px-5 py-8 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="kane" class="leading-7 text-sm text-gray-600">フリガナ</label>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="radio" id="male" name="male" v-model="form.gender" value="0">
                                                <label class="ml-2 mr-4" for="male">男性</label>

                                                <input type="radio" id="female" name="female" v-model="form.gender" value="1">
                                                <label class="ml-2 mr-4" for="female">女性</label>

                                                <input type="radio" id="other" name="other" v-model="form.gender" value="2">
                                                <label class="ml-2 mr-4" for="other">停止中</label>
                                            </div>
                                        </div>
